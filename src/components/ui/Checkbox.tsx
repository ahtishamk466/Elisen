...
export const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>(function Checkbox(
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className="flex h-lg w-lg shrink-0 items-center justify-center rounded-sm border border-border-strong bg-neutral-25 transition-colors duration-fast peer-checked:border-primary-900 peer-checked:bg-primary-900 peer-focus-visible:outline peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-text-primary"
      >
