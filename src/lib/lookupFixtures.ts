...
export const COMPANIES_LOOKUP: Company[] = [
  { id: 'co-aircanada', name: 'Air Canada', address1: '730 Cote Vertu West', address2: '', city: 'Dorval', provState: 'Quebec', country: 'Canada', postal: 'H4Y 1C2', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-airx', name: 'AirX', address1: 'The Old Treasury Building', address2: 'Saint Angelo Waterfront', city: 'Vittoriosa', provState: 'BRG', country: 'Malta', postal: '1721', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-aerolia', name: 'Aerolia Canada', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-dehavilland', name: 'De Havilland', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-bcci', name: 'BCCI (Bombardier Completion Centre)', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-canadair', name: 'Bombardier-Canadair', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-shaw', name: 'Shaw', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-heroux', name: 'Heroux-Devtek', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-sino', name: 'Sino Swearinigen', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: false },
  { id: 'co-jmj', name: 'JMJ Aeronautique', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-flightdata', name: 'Flight Data Technologies', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-airniugini', name: 'Air Niugini', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-deca', name: 'DECA Aviation', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-hawker', name: 'Hawker Pacific Pty Ltd', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-ramm', name: 'RAMM Aerospace', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  // Companies the project fixtures already use — active so pickers list them.
  { id: 'co-northwind', name: 'Northwind Aerospace', address1: '', address2: '', city: 'Montreal', provState: 'Quebec', country: 'Canada', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-duncan', name: 'Duncan Aviation', address1: '', address2: '', city: 'Lincoln', provState: 'Nebraska', country: 'USA', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-topaces', name: 'Top Aces', address1: '', address2: '', city: 'Dorval', provState: 'Quebec', country: 'Canada', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-abudhabi', name: 'Abu Dhabi Aviation', address1: '', address2: '', city: 'Abu Dhabi', provState: '', country: 'UAE', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-meridian', name: 'Meridian Charter', address1: '', address2: '', city: '', provState: '', country: '', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
  { id: 'co-elisen', name: 'Elisen', address1: '', address2: '', city: 'Montreal', provState: 'Quebec', country: 'Canada', postal: '', phoneCountryCode: '', phoneNumber: '', active: true },
]
