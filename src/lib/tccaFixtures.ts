...
export const TCCA_PROJECTS: TccaProject[] = [
  {
    ...
    priority: '1.0', certificate: 'STC SA25-200', issueNumber: '2', issued: true,
    projectStatus: 'in-progress', projectLevel: 'major',
    expectedFaiDate: '2026-03-18', expectedTestingDate: '2026-04-22',
    expectedApprovalDate: '2026-05-20', expectedDeliveryDate: '2026-06-15',
    status: 'in-progress',
  ...
  },
  {
    ...
    priority: '2.0', certificate: 'STC SA24-018', issueNumber: '1', issued: true,
    projectStatus: 'complete', projectLevel: 'minor',
    expectedFaiDate: '2024-05-02', expectedTestingDate: '2024-06-11',
    expectedApprovalDate: '2024-08-15', expectedDeliveryDate: '2024-09-01',
    status: 'approved',
  ...
  // project — a design-only job never goes to Transport Canada.
  {
    ...
    priority: '3.0', certificate: 'STC SA26-102', issueNumber: '1', issued: false,
    projectStatus: 'in-progress', projectLevel: 'minor',
    expectedFaiDate: '2026-02-10', expectedTestingDate: '2026-03-14',
    expectedApprovalDate: '', expectedDeliveryDate: '',
  ...
  },
  {
    ...
    priority: '4.0', certificate: '', issueNumber: '', issued: false,
    projectStatus: 'not-started', projectLevel: 'not-assigned',
    expectedFaiDate: '', expectedTestingDate: '',
    expectedApprovalDate: '', expectedDeliveryDate: '',
  ...
  },
  {
    ...
    priority: '2.5', certificate: 'STC SA25-206', issueNumber: '1', issued: false,
    projectStatus: 'on-hold', projectLevel: 'major',
    expectedFaiDate: '2026-01-20', expectedTestingDate: '',
    expectedApprovalDate: '', expectedDeliveryDate: '',
