...
export const PROJECT_ROWS: ProjectListRow[] = [
  ...
  },
  {
    ...
    openedDate: '2026-01-15', dueDate: '', aircraftInputDate: '', closedDate: '',
    scope: [], contractCurrency: 'USD', contractValue: '', proposalSubmitted: 'no', proposalSubmittedDate: '', proposalAccepted: 'no', proposalAcceptedDate: '',
